...
@interface LWCardManagerLayout ()<UIGestureRecognizerDelegate>
...
@implementation LWCardManagerLayout
...
- (void)longGesture:(UILongPressGestureRecognizer *)gesture
{
    switch (gesture.state) {
        case UIGestureRecognizerStateBegan: {  //手势开始
            ...
            self.moveView.layer.borderColor = UIColorFromRGB(0xebebeb).CGColor;
        ...
        case UIGestureRecognizerStateChanged: { //手势在变化
            ...
            if (indexPath == nil || self.currentIndexPath == nil)  return;
